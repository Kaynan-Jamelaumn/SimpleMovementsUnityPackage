using System;
using UnityEngine;
public class SingleSplatMapData
{
...
public static class SingleSplatMapGenerator
{
    public static Texture2D GenerateSplatMap(SingleTerrainGenerator terrainGenerator, float[,] heightMap)
    {
    ...
    public static Texture2D GenerateSplatMapOutsideMainThread(SingleTerrainGenerator terrainGenerator, float[,] heightMap, Texture2D splatMap)
    {
        for (int y = 0; y < terrainGenerator.GridDepthSize; y++)
        {
            for (int x = 0; x < terrainGenerator.GridWidthSize; x++)
